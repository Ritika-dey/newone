                                    ...
                                    <div className="blog__section__blog col-sm-6" key={index}>
                                        <div className="row blog__meta">
                                            <div className="col-lg-8 col-xs-12">
                                                <p style={{ color: "black", padding: "10px" }}><span className="icon fa fa-user"></span> <strong>Posted By:-{i.name}</strong></p>
                                            </div>
                                        ...
                                        <div className="blog__row__blog">
                                            <div className="blog__row__content">
                                                ...
                                                <div className="blog__desc" dangerouslySetInnerHTML={{__html: i.body.slice(0,75)}}> 
                                                </div>
