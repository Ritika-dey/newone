                                ...
                                <div className="blog__row__blog" key={index}>
                                    <div class="row blog__meta">
                                        <div class="col-lg-8 col-xs-12">
                                            <p style={{ color: "black", padding: "10px" }}><span class="icon fa fa-user"></span> <strong>&nbsp;{i.name}</strong></p>
                                        </div>
                                    ...
                                    <div className="blog__row__content">
                                        ...
                                        <div className="row blog__meta">
                                            <div className="col-lg-6 col-xs-12 like"><i class="fa fa-thumbs-up" aria-hidden="true" onClick={() => { likePost(i._id) }}></i>&nbsp;{i.likes.length}</div>
